...
export function Header({
  ...
  return (
    <header className="sticky top-0 z-50 w-full overflow-x-hidden border-b border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-950">
      <div className="relative mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:h-20 md:px-8">
      ...
      {isMobileDrawerOpen ? (
        <>
          <div
            className="fixed inset-0 z-[100] bg-black/45 md:hidden dark:bg-black/60"
            aria-hidden
            onClick={closeDrawer}
          />
          <div
            ...
            className="fixed inset-y-0 right-0 z-[101] flex max-h-[100dvh] w-[min(100vw,20rem)] flex-col border-l border-slate-200 bg-white shadow-2xl md:hidden dark:border-slate-700 dark:bg-slate-950"
          >
      ...
      {isAuthModalOpen ? (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/40 px-4 dark:bg-black/60">
